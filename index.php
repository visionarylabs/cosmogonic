<?php /* 
    Cosmogonic | Sample HTML5 Web Game
*/ ?>
<html>
    <head>
        <title>Cosmogonic | Space Combat | Web Game | HTML5 | JavaScript</title>
    ...
    <body>
        ...
        <div id="game-info" class="game-info">
            ...
            <p><a href="https://github.com/visionarylabs/cosmogonic">Cosmogonic source code on GitHub</a></p>
            <h3>Credits</h3>
